...
describe('Book e2e test', () => {
    ...
    it('should load Books', async () => {
        ...
        expect(await bookComponentsPage.getTitle()).to.eq('apigatewayApp.app1Book.home.title');
    });

    it('should load create Book page', async () => {
        await bookComponentsPage.clickOnCreateButton();
        bookUpdatePage = new BookUpdatePage();
        expect(await bookUpdatePage.getPageTitle()).to.eq('apigatewayApp.app1Book.home.createOrEditLabel');
    ...
    it('should delete last Book', async () => {
        ...
        expect(await bookDeleteDialog.getDialogTitle()).to.eq('apigatewayApp.app1Book.delete.question');
