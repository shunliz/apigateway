...
describe('Author e2e test', () => {
    ...
    it('should load Authors', async () => {
        ...
        expect(await authorComponentsPage.getTitle()).to.eq('apigatewayApp.app1Author.home.title');
    });
    ...
    it('should load create Author page', async () => {
        ...
        expect(await authorUpdatePage.getPageTitle()).to.eq('apigatewayApp.app1Author.home.createOrEditLabel');
    ...
    it('should delete last Author', async () => {
        ...
        expect(await authorDeleteDialog.getDialogTitle()).to.eq('apigatewayApp.app1Author.delete.question');
